    ...
    return `
        <div class="group relative pb-4">
            ...
            <div class="mt-4 flex justify-between">
                ...
                <button onclick="addToCart(${coffee.id})" class="addToCart float rounded-md bg-light-brown px-3.5 py-2.5 text-sm font-semibold text-black shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                    Add to cart
                </button>
        </div>`;
};
